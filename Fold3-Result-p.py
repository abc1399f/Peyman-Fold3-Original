...
data_dir = os.path.join( '/content/Peyman-Fold3-Original/data/Peyman-Fold3-Original/')
...
output_dir = '/content/Peyman-Fold3-Original/output/'
...
class CoNLLDataProcessor(DataProcessor):
    ...
    def __init__(self):
        self._label_types = [ 'X', '[CLS]', '[SEP]', 'O', 'I_LOC', 'B_LOC', 'I_PER', 'I_PER', 'I_ORG', 'B_ORG','I_TIM','B_TIM', 'B_DAT', 'B_DAT', 'B_MON', 'I_MON', 'B_PCT', 'I_PCT']
